...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="?p=alertes" class="<?= $p === 'alertes' ? 'active' : '' ?>"><i class="fa-solid fa-shield-halved"></i> <span>Sistema d'Alertes</span></a></li>
            <li><a href="?p=collites" class="<?= $p === 'collites' ? 'active' : '' ?>"><i class="fa-solid fa-wheat-awn"></i> <span>Collites</span></a></li>
            <li><a href="?p=qualitat" class="<?= $p === 'qualitat' ? 'active' : '' ?>"><i class="fa-solid fa-microscope"></i> <span>Control Qualitat</span></a></li>
